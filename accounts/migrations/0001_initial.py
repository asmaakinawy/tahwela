# Generated by Django 3.1.5 on 2021-01-30 23:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.ImageField(blank=True, null=True, upload_to=accounts.models.photos_directory_path)),
                ('address', models.CharField(blank=True, max_length=128, null=True)),
                ('balance', models.CharField(blank=True, default=0, max_length=128, null=True)),
                ('addings_per_day', models.CharField(blank=True, default=0, max_length=128, null=True)),
                ('addings_per_week', models.CharField(blank=True, default=0, max_length=128, null=True)),
                ('expenses_per_day', models.CharField(blank=True, default=0, max_length=128, null=True)),
                ('expenses_per_week', models.CharField(blank=True, max_length=128, null=True)),
